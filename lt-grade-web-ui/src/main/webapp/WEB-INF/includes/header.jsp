<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <!--============ All CSS Links ===========-->
    <link rel="stylesheet" href="/static/assets/bootstrap-4.0.0-beta.3-dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="/static/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="/static/assets/css/ionicons.css">
    <link rel="stylesheet" href="/static/assets/plugins/slick/slick.css">
    <link rel="stylesheet" href="/static/assets/plugins/slick/slick-theme.css">
